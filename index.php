	...
	<div class="row">
		...
		<div class="col-md-4 login-sec">
          ...
          <div class="form-group">
            ...
            <button type="submit" class="btn btn-login float-right" id="loginsubmit">Submit</button>
          </div> 
        </div>
<div class="copy-text"><a href="reset_password.php">Forgot password?</a></div>
    ...
    <div class="carousel-item active">
        <img class="d-block img-fluid" src="assets/img/kid.jpg" alt="First slide">
...
<!--    <div class="carousel-item">
    ...
    <div class="carousel-item">
        <img class="d-block img-fluid" src="assets/img/drop_bus.png" alt="First slide">
      <div class="carousel-caption d-none d-md-block">
        <div class="banner-text">
            <h2>This is Heaven</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation</p>
