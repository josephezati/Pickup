...
include'../../db_connection.php';
	...
	$sql = "INSERT INTO users(fname,lname,telephone,email,username,usertype,password) VALUES('$fname','$lname','$phone','$mail','$username','$usertype','$password')" or die(mysqli_error($conn));
// }
